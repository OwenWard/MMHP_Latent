...
## Fit in model 1
sim_model2_stan_fit1[[1]] <- sampling(model1, 
                                      data = data_list, 
                                      iter = 1000, chains = 4)
print("model2")
## Fit in model 2
...
## TO DO
####
lam0_vec <- apply(sim_model2_stan_sim3$lambda0, 2, mean)
lam1_vec <- apply(sim_model2_stan_sim3$lambda1, 2, mean)
...
mmhp_par_est <- list(lambda0 = lam0_par_est,
                     ...
                     eta_1 = mean(sim_model2_stan_sim3$eta_1),
                     eta_2 = mean(sim_model2_stan_sim3$eta_2),
                     eta_3 = mean(sim_model2_stan_sim3$eta_3),
                     beta = mean(sim_model2_stan_sim3$beta),
                     f = apply(sim_model2_stan_sim3$f, 2, mean))
