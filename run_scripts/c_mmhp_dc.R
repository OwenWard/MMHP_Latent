...
# cohort_id <- 1
####
save_data_path <- "output/revisions/lapl_check/ident_check_no_eta1/"
...
# 
#         viterbi_result <- myViterbiWithInitial(
#           events = time_vec, param = param_pair,
