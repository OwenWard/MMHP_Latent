...
#   print(n = 30)
# mcmc_trace(sim_fit1_draws, pars = c("eta_1", "eta_2", "eta_3"))
# mcmc_trace(sim_fit1_draws, pars = c("f[1]", "f[2]", "f[3]", "f[4]", "f[5]"))
# mcmc_trace(sim_fit1_draws, pars = c("lp__", "lambda0", "beta"))
...
# 
# 
# mcmc_trace(sim_model3_fit_2, pars = c("eta_1", "eta_2", "eta_3"))
# mcmc_trace(sim_model3_fit_2, pars = c("f[1]", "f[2]", "f[3]", "f[4]", "f[5]"))
# mcmc_trace(sim_model3_fit_2, pars = c("gamma[1]",
#                                       "gamma[2]",
#                                       "gamma[3]",
#                                       "gamma[4]",
#                                       "gamma[5]"))
# mcmc_trace(sim_model3_fit_2, pars = c("zeta[1]",
#                                       "zeta[2]",
#                                       "zeta[3]",
#                                       "zeta[4]",
#                                       "zeta[5]"))
# mcmc_trace(sim_model3_fit_2, pars = c("lp__", "beta_delta", "beta"))
...
# 
sim_fit_3 <- sim_stan_fit3$draws()
sim_fit3_draws <- posterior::as_draws_df(sim_fit_3)

### mcmc diagnostics
# sim_model3_stan_fit3$summary() %>% 
#   select(variable, mean, rhat) %>% 
#   print(n = 100)
# 
# 
# mcmc_trace(sim_model3_fit_3, pars = c("eta_1", "eta_2", "eta_3"))
# mcmc_trace(sim_model3_fit_3, pars = c("f[1]", "f[2]", "f[3]", "f[4]", "f[5]"))
# mcmc_trace(sim_model3_fit_3, pars = c("gamma[1]",
#                                       "gamma[2]",
#                                       "gamma[3]",
#                                       "gamma[4]",
#                                       "gamma[5]"))
# mcmc_trace(sim_model3_fit_3, pars = c("zeta[1]",
#                                       "zeta[2]",
#                                       "zeta[3]",
#                                       "zeta[4]",
#                                       "zeta[5]"))
# mcmc_trace(sim_model3_fit_3, pars = c("lp__", "beta_delta", "beta"))
