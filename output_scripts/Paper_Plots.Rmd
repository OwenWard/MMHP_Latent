...
<!-- ```{r fig_3b_update, fig.height=7, include=FALSE, eval=FALSE} -->
...
<!-- ```{r repeat entire fig2b for model 2, include=extra_plots, eval=extra_plots} -->
<!-- # current_cohort <- 5 -->
...
legend.x <- c(40,40,40)#c(135,135,135)
legend.y <- #c(34,32,32)
legend.y <- c(10,10,10)#c(15,12,15)#c(62,37,18)#c(22,22,22)
legend.cex <- 1.5 #3
...
legend(legend.x[2]-35,
       ...
       pch = c(NA,4), pt.cex = c(NA,2), cex=legend.cex,
       lty = c(NA,NA), lwd=c(NA,4))
points(8,legend.y[2] - 2, pch = 1, cex = 2, col = "blue")
points(10,legend.y[2] - 2, pch = 16, cex = 2, col = "blue")
...
legend(legend.x[3]-30,legend.y[3]+2, c("Overestimation","Underestimation"),
...
```{r fig-8b-frob-norm-boxplot, fig.width=8, fig.height=4}
load("../output/plot_N_predict.RData")
