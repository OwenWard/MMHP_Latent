...
```{r fig-4a, fig.height=6,fig.width=8}
...
```{r fig4b-recover-latent-states,fig.width=8,fig.height=5}
...
legend(legend.x[2]-45,
       ...
       pch = c(NA,4), pt.cex = c(NA,2), cex=legend.cex,
       lty = c(NA,NA), lwd=c(NA,4))
points(110,legend.y[2] - 3, pch = 1, cex = 2, col = "blue")
points(113,legend.y[2] - 3, pch = 16, cex = 2, col = "blue")
...
```{r fig-7-prMatrix-Cohort5, fig.width=7, fig.height=7}
current_cohort <- 5
