...
```{r fig-3a-baseline-rate, fig.width=5, fig.height=5, eval=revision_plots}
current_cohort <- 5
## this looks better
...
myMultiMatrixPlot(
  ...
  col_axis = c(-80, -40, 0, 40, 80), fake_matrix = TRUE,
...
```{r fig-4a, eval = revision_plots, message=FALSE, warning=FALSE}
...
```{r prepare data for 4b,cache=TRUE, eval=TRUE}
...
```{r fig-4b-recover-latent-states,fig.width=8,fig.height=4, eval=TRUE}
mmhp_lty <- 1
...
```{r data for fig 5,cache=TRUE, eval=revision_plots}
n_sim <- 50
num_nodes <- 10
...
load("../output/revisions/lapl_check/weighted_rank_data.RData")
...
```{r fig-8a-mae-norm-cohort5, fig.width=8,fig.height=4,eval=TRUE}
...
```{r fig-7a-pred-all-cohorts-box-mae,eval=TRUE, fig.width=8, fig.height=4}
### updated to revision
load("../output/revisions/aug_run/plot_N_predict_revision.RData")
...
load("../output/revisions/lapl_check/plot_rank_predict.RData")
