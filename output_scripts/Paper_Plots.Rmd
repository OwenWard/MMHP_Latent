...
legend.x <- c(30,30,30)#c(135,135,135)
legend.y <- #c(34,32,32)
legend.y <- c(2.5,2,2)#c(15,12,15)#c(62,37,18)#c(22,22,22)
legend.cex <- 1.5 #3
...
legend(legend.x[1]-20,legend.y[3],c("Overestimation","Underestimation"),
