...
required for this paper. We will currently build them using the refit version of Jing's fit,
which ignored windows with no events (to confirm we can recreate that exactly).
