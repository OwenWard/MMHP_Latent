...
mtext(text=c(1:5), side=2, line=0.5, outer=TRUE, cex=2, las=2,
      at=c(0:4)/5+0.1)
mtext(text=c(1:5), side=1, line=1, outer=TRUE, cex=2,
      at=c(0:4)/5+0.1)
...
=======
current_cohort <- 5
>>>>>>> 971945f60ca951aa30d275aaae42cbb85323e84c
...
testing_end <- nrow(df)#1077 #929 for cohort 5
...
for(s in 1:100){
  ...
  temp_gl <- glickoScoreSimulationWithWindowsReturnAll(
    predict.sim = m3_predict_sim[5:8,s],
