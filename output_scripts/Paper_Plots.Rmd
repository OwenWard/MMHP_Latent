...
```{r fig-8b-frob-norm-all-cohorts,fig.width=8,fig.height=4, eval=FALSE}
load("../output/plot_N_predict.RData")
...
```{r fig-7-pred-all-cohorts-box, fig.width=8, fig.height=4}
load("../output/plot_N_predict.RData")
...
```{r fig-7-pred-rank-spearman-all-cohorts}
load("../output/plot_rank_predict.RData")
