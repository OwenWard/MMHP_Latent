...
for(current_cohort in 1:10){
  ...
  p <- mice_covars %>% ggplot(aes(true_rank,perm_rank)) + geom_point() +
    ggtitle(paste("Cohort ",current_cohort,sep = ""))
  
  q <- mice_covars %>% ggplot(aes(true_gam,perm_gam)) + geom_point()
  
  r <- mice_covars %>% ggplot(aes(true_zeta,perm_zeta)) + geom_point()
