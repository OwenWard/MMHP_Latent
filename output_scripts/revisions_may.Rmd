...
legend.y <- # c(34,32,32)
legend.y <- c(2, 2, 2) # c(15,12,15)#c(62,37,18)#c(22,22,22)
legend.cex <- 1.5 # 3
...
#   legend.y[2] + 1, c("State 0/1 events", "State change point"),
#   col = c(NA, "red"),
#   y.intersp = 0.85, x.intersp = -0.5, bty = "n",
#   pch = c(NA, 4), pt.cex = c(NA, 2), cex = legend.cex,
#   lty = c(NA, NA), lwd = c(NA, 2)
# )
# points(legend.x[2] - 46, legend.y[2] - .5, pch = 1, cex = 2, col = "blue")
# points(legend.x[2] - 44, legend.y[2] - .5, pch = 16, cex = 2, col = "blue")
...
# legend(legend.x[3] - 50, legend.y[3] + 2,
...
par(mar = c(0, 0.3, 0, 0.1))
plot(0, 0,
  xlim = c(0, my.xlim), ylim = c(-1, 1.5), type = "n",
